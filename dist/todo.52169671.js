...
},{"@popperjs/core":"../node_modules/@popperjs/core/lib/index.js"}],"js/todo.js":[function(require,module,exports) {
"use strict";
...
var currentActiveUserEmail = localStorage.getItem("currentActiveUserEmail");
console.log(isLoggedIn, userInfo);

if (isLoggedIn && userInfo.length > 0) {
  console.log("heeeey"); //   getLoggedUserTodos(userInfo[0].userId).then(result => console.log(result));

  var activeUser = userInfo.find(function (el) {
    return el.email === currentActiveUserEmail;
  });

  if (JSON.parse(localStorage.getItem("usersWithModifiedTodos")) && JSON.parse(localStorage.getItem("usersWithModifiedTodos")).find(function (el) {
    return el.email === currentActiveUserEmail;
  })) {
    var storedTodos = JSON.parse(localStorage.getItem("usersIdsTodos"));
...
function getLoggedUserTodos(_x) {
  return _getLoggedUserTodos.apply(this, arguments);
}

function _getLoggedUserTodos() {
  _getLoggedUserTodos = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userId) {
    var data, todos, _storedTodos4;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("https://jsonplaceholder.typicode.com/users/".concat(userId, "/todos"), {
              method: "GET",
              headers: {
          ...
          case 3:
            ...
            throw new Error("HTTP error! status: ".concat(data.status));
          ...
          case 9:
            todos = _context.sent;
            localStorage.setItem("usersIdsTodos", JSON.stringify(_defineProperty({}, userId, todos)));
            _storedTodos4 = JSON.parse(localStorage.getItem("usersIdsTodos"));
            console.log(_storedTodos4);
            renderUserTodos(_storedTodos4[userId]);
            _context.next = 19;
            break;
...
function renderUserTodos(todos) {
  list.innerHTML = todos.map(function (todo) {
    return " <li class=\" my-3 py-3 shadow list-group-item \" id=\"list".concat(todo.id, "\">\n    <div class=\"row\">\n    <div class=\"col-1\">\n    <input class=\"\" type=\"checkbox\" id=\"check").concat(todo.id, "\"   ").concat(todo.completed ? "checked" : null, " >\n    </div>\n    <div class=\"col-6\">\n        <span class=\" h4 ").concat(todo.completed ? "text-decoration-line-through" : null, "\" id=\"text").concat(todo.id, "\"> ").concat(todo.title, " </span>\n    </div>\n    <div class=\"col-4\">\n         <button class=\" btn btn-dark deleteBtn\" >Delete</button>\n         <button class=\" btn btn-dark editBtn\" >Edit</button>\n    </div>                  \n     </div>    \n    </li> ");
  });
}
...
function _createNewTodo() {
  _createNewTodo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(recentAddedTodo) {
    var data, todos;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch("https://jsonplaceholder.typicode.com/users/".concat(recentAddedTodo.userId, "/todos"), {
              method: "POST",
              headers: {
                Accept: "application/json",
                "Content-Type": "application/json"
          ...
          case 12:
            ...
            console.log("There has been a problem with your fetch operation: " + _context2.t0.message);
...
addBtn.addEventListener("click", function (e) {
  var inputText = filterList(input.value);
  var storedTodos = JSON.parse(localStorage.getItem("usersIdsTodos"));
  var activeUser = userInfo.find(function (el) {
    return el.email === currentActiveUserEmail;
  });
  console.log(activeUser);
  var newTodoId = storedTodos[activeUser.userId][storedTodos[activeUser.userId].length - 1].id + 20;
  var recentAddedTodo = {
    completed: false,
    id: newTodoId,
    title: inputText,
  ...
  var newTodos = [recentAddedTodo].concat(_toConsumableArray(storedTodos[activeUser.userId]));

  if (inputText) {
    createNewTodo(recentAddedTodo);
    localStorage.setItem("usersIdsTodos", JSON.stringify(_defineProperty({}, activeUser.userId, newTodos)));

    if (JSON.parse(localStorage.getItem("usersWithModifiedTodos"))) {
      localStorage.setItem("usersWithModifiedTodos", JSON.stringify([].concat(_toConsumableArray(JSON.parse(localStorage.getItem("usersWithModifiedTodos"))), [activeUser]).filter(function (value, index, self) {
        return index === self.findIndex(function (t) {
          return t.email === value.email;
        });
      })));
    } else {
      localStorage.setItem("usersWithModifiedTodos", JSON.stringify([activeUser].filter(function (value, index, self) {
        return index === self.findIndex(function (t) {
          return t.email === value.email;
        });
      })));
...
function _deleteTodo() {
  _deleteTodo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(todoId) {
    var data, todos;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 13:
            ...
            console.log("There has been a problem with your fetch operation: " + _context3.t0.message);
...
list.addEventListener("click", function (e) {
  if (e.target.matches(".deleteBtn")) {
    e.preventDefault();
    var deleteComfirm = confirm("Are you sure to delete ".concat(e.target.parentElement.parentElement.querySelector("span").innerHTML));

    if (deleteComfirm) {
      var _storedTodos = JSON.parse(localStorage.getItem("usersIdsTodos"));

      var _activeUser = userInfo.find(function (el) {
        return el.email === currentActiveUserEmail;
      });

      var newTodos = _storedTodos[_activeUser.userId].filter(function (el) {
        return el.title != e.target.parentElement.parentElement.querySelector("span").innerText;
      });

      console.log(newTodos);
      deleteTodo(_activeUser.userId);
      localStorage.setItem("usersIdsTodos", JSON.stringify(_defineProperty({}, _activeUser.userId, newTodos)));

      if (JSON.parse(localStorage.getItem("usersWithModifiedTodos"))) {
        localStorage.setItem("usersWithModifiedTodos", JSON.stringify([].concat(_toConsumableArray(JSON.parse(localStorage.getItem("usersWithModifiedTodos"))), [_activeUser]).filter(function (value, index, self) {
          return index === self.findIndex(function (t) {
            return t.email === value.email;
          });
        })));
      } else {
        localStorage.setItem("usersWithModifiedTodos", JSON.stringify([_activeUser].filter(function (value, index, self) {
          return index === self.findIndex(function (t) {
            return t.email === value.email;
          });
        })));
...
function updateTodo(_x4, _x5) {
  return _updateTodo.apply(this, arguments);
}

function _updateTodo() {
  _updateTodo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(todoId, updatedData) {
    var data, todos;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 12:
            ...
            console.log("There has been a problem with your fetch operation: " + _context4.t0.message);
...
list.addEventListener("click", function (e) {
  if (e.target.matches('[type="checkbox"]')) {
    ...
    var spanId = checkboxId.split("k")[1];
    spanId = "text".concat(spanId);
    var span = document.getElementById(spanId);
    console.log(span);

    var _storedTodos2 = JSON.parse(localStorage.getItem("usersIdsTodos"));

    var _activeUser2 = userInfo.find(function (el) {
      return el.email === currentActiveUserEmail;
    });

    var editedTodoIndex = _storedTodos2[_activeUser2.userId].findIndex(function (el) {
      return el.title == span.innerText;
    });

    var newTodos = _toConsumableArray(_storedTodos2[_activeUser2.userId]);

    newTodos[editedTodoIndex].completed = !_storedTodos2[_activeUser2.userId][editedTodoIndex].completed;
    ...
    localStorage.setItem("usersIdsTodos", JSON.stringify(_defineProperty({}, _activeUser2.userId, newTodos)));

    if (JSON.parse(localStorage.getItem("usersWithModifiedTodos"))) {
      localStorage.setItem("usersWithModifiedTodos", JSON.stringify([].concat(_toConsumableArray(JSON.parse(localStorage.getItem("usersWithModifiedTodos"))), [_activeUser2]).filter(function (value, index, self) {
        return index === self.findIndex(function (t) {
          return t.email === value.email;
        });
      })));
    } else {
      localStorage.setItem("usersWithModifiedTodos", JSON.stringify([_activeUser2]));
    }
...
list.addEventListener("click", function (e) {
  if (e.target.matches(".editBtn")) {
    e.preventDefault();
    var currentText = e.target.parentElement.parentElement.querySelector("span");
    var newText = prompt("Wanna Change list?", currentText.innerHTML);

    if (filterList(newText)) {
      var _storedTodos3 = JSON.parse(localStorage.getItem("usersIdsTodos"));

      var _activeUser3 = userInfo.find(function (el) {
        return el.email === currentActiveUserEmail;
      });

      var editedTodoIndex = _storedTodos3[_activeUser3.userId].findIndex(function (el) {
        return el.title == currentText.innerText;
      });

      var newTodos = _toConsumableArray(_storedTodos3[_activeUser3.userId]);
      ...
      localStorage.setItem("usersIdsTodos", JSON.stringify(_defineProperty({}, _activeUser3.userId, newTodos)));

      if (JSON.parse(localStorage.getItem("usersWithModifiedTodos"))) {
        localStorage.setItem("usersWithModifiedTodos", JSON.stringify([].concat(_toConsumableArray(JSON.parse(localStorage.getItem("usersWithModifiedTodos"))), [_activeUser3]).filter(function (value, index, self) {
          return index === self.findIndex(function (t) {
            return t.email === value.email;
          });
        })));
      } else {
        localStorage.setItem("usersWithModifiedTodos", JSON.stringify([_activeUser3]));
      }
...
var filterList = function filterList(x) {
  if (x) {
