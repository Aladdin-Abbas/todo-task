...
var agreeCheckbox = document.getElementById("agree-check");
...
var validatePassword = function validatePassword() {
  if (!password.value || password.value.length < 8 || !password.value.match(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/)) {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            if (JSON.parse(localStorage.getItem("userInfo"))) {
              localStorage.setItem("userInfo", JSON.stringify([].concat(_toConsumableArray(JSON.parse(localStorage.getItem("userInfo"))), [{
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10891" + '/');
